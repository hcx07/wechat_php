<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"E:\wechatphp\public/../application/index\view\article\article_list.php";i:1521879651;s:46:"E:\wechatphp\application\index\view\layout.php";i:1521879573;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="">
        <div class="page-title">
            ...
            <div class="title_left">
                <small><a class="btn btn-primary radius" onclick="picture_add('添加用户','<?php echo Url('article/add'); ?>')" href="javascript:;">
                        添加文章</a></small>
            </div>
