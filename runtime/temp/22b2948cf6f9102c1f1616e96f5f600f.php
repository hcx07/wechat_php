<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"E:\wechatphp\public/../application/index\view\article\add.php";i:1521881844;}*/ ?>
﻿<!-- Bootstrap -->
                                ...
                                <div id="fileList" class="uploader-list">
                                    <?php foreach ($banner as $val):?>
                                        <div id="<?php echo uniqid('img')?>" class="file-item thumbnail">
                                            ...
                                            <input name="banner[]" type="hidden" value="<?php echo $val; ?>">
                                            <div class="info"></div>
                                        </div>
                                    <?php endforeach;?>
                                </div>
...
<script>
    ...
    $(function () {
        ...
        var uploader = WebUploader.create({
            ...
            server: "<?php echo url('article/upload'); ?>",
